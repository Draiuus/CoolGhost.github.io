    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError(
        <>
          ...
          <br />
          But don't worry! <span className="emoji">🕵️‍♂️</span> You can always interact with the smart-contract through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a> and <strong>we do our best to provide you with the best user experience possible</strong>, even from there.<br />
          <br />
        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              Hey, looking for a <strong>super-safe experience</strong>? <span className="emoji">🕵️‍♂️</span><br />
              ...
              <br />
              𝓴𝓮𝓮𝓹 𝓼𝓪𝓯𝓮! <span className="emoji">👻👻👻</span>
            </div>
